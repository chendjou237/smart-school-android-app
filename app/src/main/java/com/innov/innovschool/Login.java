...
public class Login extends Activity {
    ...
    LinearLayout changeUrlBtn,adminloginBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminloginBtn = (LinearLayout) findViewById(R.id.btn_admin_login);
